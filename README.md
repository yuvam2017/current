...
| `right-now.html` | Single-file app: local passcode login, full-screen "current task" display, editable timetable, CSV/Excel/TXT/JSON import |
...
{
  "Monday": [
    { "time": "09:00", "label": "Core One" },
    { "time": "12:00", "label": "Free" }
  ],
  "Tuesday": [ ... ],
  "Wednesday": [ ... ],
  "Thursday": [ ... ],
...
`right-now.html` currently reads a **flat array** (`[{ "time": ..., "label": ... }, ...]`), not a week-keyed object. To load one day from `schedule-week.json`:

1. Open `right-now.html`, tap the ✎ (edit) icon.
